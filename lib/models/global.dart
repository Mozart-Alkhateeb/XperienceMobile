...
//  final User user = new User(10,"kallee","",AssetImage('lib/assets/my_profile.jpg'),true,DateTime.now(),"female","koukou",3,4,"kouki","kouki@hotmail.com","kallehallden", [ follower1, follower2, follower3], [follower1, follower2,follower3, follower4, follower5, follower6], [], [], false);
//User follower1 = new User(1,"kallee","",AssetImage('lib/assets/my_profile.jpg'),true,DateTime.now(),"female","koukou",3,4,"kouki","kouki@hotmail.com","kallehallden",[], [], [], [], true);
//User follower2 = new User(2,"kallee","",AssetImage('lib/assets/my_profile.jpg'),true,DateTime.now(),"female","koukou",3,4,"kouki","kouki@hotmail.com","kallehallden", [], [], [], [], false);
//User follower3 = new User(3,"kallee","",AssetImage('lib/assets/my_profile.jpg'),true,DateTime.now(),"female","koukou",3,4,"kouki","kouki@hotmail.com","kallehallden",[], [], [], [], true);
//User follower4 = new User(4,"kallee","",AssetImage('lib/assets/my_profile.jpg'),true,DateTime.now(),"female","koukou",3,4,"kouki","kouki@hotmail.com","kallehallden", [], [], [], [], true);
//User follower5 = new User(5,"kallee","",AssetImage('lib/assets/my_profile.jpg'),true,DateTime.now(),"female","koukou",3,4,"kouki","kouki@hotmail.com","kallehallden", [], [], [], [], true);
//User follower6 = new User(6,"kallee","",AssetImage('lib/assets/my_profile.jpg'),true,DateTime.now(),"female","koukou",3,4,"kouki","kouki@hotmail.com","kallehallden", [], [], [], [], false);
//List<Post> userPosts = [
